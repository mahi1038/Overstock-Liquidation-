...
CALENDAR_FILE_PATH = 'E:\environments\wallmart_hackathon\dataset\m5-forecasting-accuracy\calendar.csv'
SALES_FILE_PATH = 'E:\environments\wallmart_hackathon\dataset\m5-forecasting-accuracy\sales_train_validation.csv'
PRICES_FILE_PATH = 'E:\environments\wallmart_hackathon\dataset\m5-forecasting-accuracy\sell_prices.csv'
