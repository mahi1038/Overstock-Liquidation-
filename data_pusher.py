...
class DataPusher:
    ...
    def get_evaluation_dataframe(self):
     ...
     final_columns = ['date', 'item_id', 'dept_id', 'store_id', 'state_id', 'weekday', 'month', 'week_of_month', 'event_name_1', 'event_type_1', 'event_name_2',
            'event_type_2', 'snap_active', 'sell_price', 'lag_28', 'lag_7', 'rolling_mean_28',  'price_pct_change', 'zero_streak', 'sales', 'sales_28_sum']
