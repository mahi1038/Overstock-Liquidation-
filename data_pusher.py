...
class DataPusher:
    ...
    def get_evaluation_dataframe(self):
     ...
     final_columns = [
        ...
        'event_name_1', 'event_type_1', 'event_name_2', 'event_type_2', 'snap_active',
        'sell_price', 'lag_28', 'lag_7', 'rolling_mean_28', 'price_pct_change',
        'zero_streak', 'sales_28_sum'
     ]

     # ✅ Now drop rows with missing values in feature columns
     final_df = final_df.dropna(subset=[
         'lag_28', 'lag_7', 'rolling_mean_28',
         'sales_28_sum', 'price_pct_change', 'zero_streak'
     ])
